...
API FastAPI de FabriQ v0.11.0 (developpements v0.12.0/v0.13.0 en cours, non taguees — voir [../CHANGELOG.md](../CHANGELOG.md)).

La version exposee par FastAPI (`/api/health`) est `0.11.0`.
